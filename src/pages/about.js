  ...
  return (
    <Layout>
      <section className="mt-20 mb-20 px-6 mx-auto max-w-lg md:max-w-xl lg:max-w-4xl">
        ...
        <p className="mb-6">
          At Nevermore, we believe in going beyond cleaning and just removal. Our commitment
          to responsible cleaning and disposal is at the core of our mission. We ensure that
        ...
        <p className="mb-6">
          ...
          mark in the cleaning and junk removal industry. With fresh ideas, a dedicated team,
        ...
        <p>
          Thank you for considering Nevermore for your cleaning and junk removal needs. We
        ...
        <p className="mb-6">
          To provide efficient, affordable, responsible cleaning and junk removal
