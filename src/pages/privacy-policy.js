...
// Privacy Policy: https://www.termsfeed.com/live/dea11ba4-8404-4ddc-bf8a-b0c1626352cd
// Dashboard: https://app.termsfeed.com/download/dea11ba4-8404-4ddc-bf8a-b0c1626352cd
  ...
  return (
    <Layout>
      <div className="p-4 md:p-16">
        ...
        <p className="mb-2">Last updated: August 21, 2024</p>
        <p className="mb-2">
        ...
        <h2 className="mb-2 mt-8">Interpretation and Definitions</h2>
        ...
        <ul className="my-4 pl-2">
          ...
          <li>
            <p className="mb-2">
              ...
              in this Agreement) refers to Nevermore Cleaning &amp; Junk Removal
              LLC, 705 Bunneck Ave, MD 21211.
            </p>
          </li>
          <li>
            <p className="mb-2">
          ...
          <li>
            <p className="mb-2">
              <strong>Website</strong> refers to Nevermore Cleaning &amp; Junk
              Removal, accessible from{' '}
              <a
                href="http://www.letstalknevermore.com"
                rel="external nofollow noopener noreferrer"
                target="_blank"
              >
                http://www.letstalknevermore.com
              </a>
            </p>
          </li>
          <li>
        ...
        <h2 className="mb-2 mt-8">Collecting and Using Your Personal Data</h2>
        ...
        <h2 className="mb-2 mt-8">Children's Privacy</h2>
        <p className="mb-2">
        ...
        <h2 className="mb-2 mt-8">Links to Other Websites</h2>
        <p className="mb-2">
        ...
        <h2 className="mb-2 mt-8">Changes to this Privacy Policy</h2>
        <p className="mb-2">
        ...
        <h2 className="mb-2 mt-8">Contact Us</h2>
        <p className="mb-2">
        ...
        <ul className="my-4 pl-2">
          <li>
            <p className="mb-2">By email: letstalknevermore@gmail.com</p>
          </li>
          <li>
            <p className="mb-2">
              By visiting this page on our website:{' '}
              <a
                href="http://www.letstalknevermore.com/contact"
                rel="external nofollow noopener noreferrer"
                target="_blank"
              >
                http://www.letstalknevermore.com/contact
              </a>
            </p>
          </li>
          <li>
            <p className="mb-2">By phone number: (443) 883-8595</p>
          </li>
        </ul>
      </div>
    </Layout>
