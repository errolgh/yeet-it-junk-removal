        ...
        <div className="flex flex-col space-y-6 w-full max-w-5xl p-8 md:flex-row md:space-x-6 md:space-y-0">
          <div className="relative flex flex-col justify-between space-y-8 md:p-12 lg:p-6">
            ...
            <div className="flex flex-col space-y-6">
              ...
              <div className="inline-flex space-x-2 items-center">
                <IoLocationSharp className="text-yellow-600 text-xl" />
                <span className="text-gray-600">Baltimore, MD</span>
              </div>
            </div>
            <div className="flex text-lg space-x-4 text-yellow-600">
              <Link to="https://www.facebook.com/profile.php?id=61553945744042">
                <IoLogoFacebook />
              </Link>
              {/* <Link to="/">
              <IoLogoTwitter />
            ...
            <Link to="/">
              ...
              <Link to="https://www.instagram.com/yeet_itjunkremoval">
                <IoLogoInstagram />
              </Link>
            </div>
          </div>
